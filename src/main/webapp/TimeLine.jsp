...
<%
// fetch user data from session, if no user data, redirect to Login page
...
ArrayList<Post> timeLinePosts = Posts.fetchTimeLinePosts(user.getAccount(),
...
<body style="background-color: rgb(50, 50, 50);">
	...
	<%
	Post post;
	for (int i = timeLinePosts.size() - 1; i >= 0; i--) {
		post = timeLinePosts.get(i);
	%>
	<div class="post">
		<p>
